...
class CheckDHCPMsg(name: String,
                   elementType: String,
...
class CheckDHCPMsgElementBuilder(name: String, elementType: String)
  ...
  override def buildElement: GenericElement = {
    new CheckDHCPMsg(name, elementType, getInputPorts, getOutputPorts, getConfigParameters)
  }
}
...
object CheckDHCPMsg {
  ...
  private val genericElementName = "checkdhcp"

  private def increment {
    unnamedCount += 1
  }

  def getBuilder(name: String): CheckDHCPMsgElementBuilder = {
    increment ; new CheckDHCPMsgElementBuilder(name, "CheckDHCPMsg")
  }

  def getBuilder: CheckDHCPMsgElementBuilder =
