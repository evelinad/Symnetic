...
class DHCPServerACKorNAK(name: String,
                   elementType: String,
...
class DHCPServerACKorNAKElementBuilder(name: String, elementType: String)
  extends ElementBuilder(name, elementType) {

  override def buildElement: GenericElement = {
    new DHCPServerACKorNAK(name, elementType, getInputPorts, getOutputPorts, getConfigParameters)
  }
}

object DHCPServerACKorNAK {
  private var unnamedCount = 0

  private val genericElementName = "dhcpserverackornak"

  private def increment {
    unnamedCount += 1
  }

  def getBuilder(name: String): DHCPServerACKorNAKElementBuilder = {
    increment ; new DHCPServerACKorNAKElementBuilder(name, "DHCPServerACKorNAK")
  }

  def getBuilder: DHCPServerACKorNAKElementBuilder =
